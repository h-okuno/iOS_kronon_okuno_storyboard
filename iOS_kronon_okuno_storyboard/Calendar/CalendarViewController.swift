...
class CalendarViewController: UIViewController, ViewLogic {
    ...
    private func settingLabel() {
        calendarTitle.text = "\(String(date.year))年\(String(date.month))月"
...
extension CalendarViewController {
    ...
    private func commonSettingMoveMonth() {
        ...
        calendarTitle.text = "\(String(moveDate.year))年\(String(moveDate.month))月"
...
extension CalendarViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        dayOfBackgroundColor(cell, indexPath.row, daysPerWeek)
    ...
    private func dayOfBackgroundColor(_ cell: UICollectionViewCell, _ row: Int, _ daysPerWeek: Int) {
        switch row % daysPerWeek {
        case 0: cell.backgroundColor = .sundayBackground()
        case 6: cell.backgroundColor = .saturdayBackground()
    ...
    private func markToday(_ label: UILabel, _ cell: UICollectionViewCell) {
        if isToday, today.description == label.text {
            cell.backgroundColor = .myLightRed()
        }
    }
